...
import {ToolDefinition} from '../../../common/src/types/types.js'
export class AnonCredsToolHandler {
	...
	createCredentialDefinitionTool(): ToolDefinition<typeof RegisterCredentialDefinitionParams> {
		return {
			...
			description:
				'Create and publish a credential definition for a specific schema id as a DID Linked Resource in Cheqd Network',
